...
collaboration = do
  ...
  fenced <- turn (checkActor consumer) ("import Tidepool.Agent.Reply (attemptReply)\nattemptReply sessionReply (Produced (Candidate " <> gitOidLiteral amendment <> " [] [\"open product gate\"]))")
